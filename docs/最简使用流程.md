...
如果你后面要切换到另一套规则，只需要替换这 6 个 CSV。

## 批量处理

1. 把待处理文档放进 [输入文档](</C:/Users/admin/Desktop/JJBand/输入文档>)
2. 确认 [规则化文件夹](</C:/Users/admin/Desktop/JJBand/规则化文件夹>) 里是要使用的规则文件
...
默认规则目录仍然是 `规则化文件夹`，默认输出目录仍然是 `输出文档`。
